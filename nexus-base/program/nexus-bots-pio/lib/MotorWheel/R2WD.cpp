...
R2WD::R2WD(MotorWheel *wheelLeft, MotorWheel *wheelRight, unsigned int wheelspanMM) : _wheelLeft(wheelLeft), _wheelRight(wheelRight), _wheelspanMM(wheelspanMM)
{
...
unsigned int R2WD::setCarArcBase(unsigned int speedMMPS, unsigned int radiusMM)
{
	...
	{
	case STAT_UPPERLEFT:
		setCarAdvanceBase(V1, V2);
		break;
	case STAT_LOWERLEFT:
		setCarBackoffBase(V1, V2);
		break;
	case STAT_UPPERRIGHT:
		setCarAdvanceBase(V2, V1);
		break;
	case STAT_LOWERRIGHT:
		setCarBackoffBase(V2, V1);
		break;
	}
	return getCarSpeedMMPS();
}
...
unsigned int R2WD::setCarSpeedMMPS(unsigned int speedMMPS, unsigned int ms)
{
	...
	{
	case STAT_ADVANCE:
		carAction = &R2WD::setCarAdvance;
		break;
	case STAT_BACKOFF:
		carAction = &R2WD::setCarBackoff;
		break;
	case STAT_ROTATELEFT:
		carAction = &R2WD::setCarRotateLeft;
		break;
	case STAT_ROTATERIGHT:
		carAction = &R2WD::setCarRotateRight;
		break;
	case STAT_UPPERLEFT:
	case STAT_LOWERLEFT:
	case STAT_LOWERRIGHT:
	case STAT_UPPERRIGHT:
		return setCarSpeedMMPSArc(speedMMPS, getRadiusMM(), ms);
		break;
	default:
		return currSpeed;
		break;
...
unsigned int R2WD::setCarSpeedMMPSArc(unsigned int speedMMPS, unsigned int radiusMM, unsigned int ms)
{
	...
	case STAT_ROTATELEFT:
	case STAT_ROTATERIGHT:
		return setCarSpeedMMPS(speedMMPS, ms);
		break;
	case STAT_UPPERLEFT:
		carAction = &R2WD::setCarUpperLeft;
		break;
	case STAT_LOWERLEFT:
		carAction = &R2WD::setCarLowerLeft;
		break;
	case STAT_LOWERRIGHT:
		carAction = &R2WD::setCarLowerRight;
		break;
	case STAT_UPPERRIGHT:
		carAction = &R2WD::setCarUpperRight;
		break;
	default:
		return currSpeed;
		break;
