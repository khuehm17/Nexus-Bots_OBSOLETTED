...
echo_and_run cd "/home/blackwind/workspace/Nexus-Bots/nexus-ros/jetnano/src/robot_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/home/blackwind/workspace/Nexus-Bots/nexus-ros/jetnano/src/robot_teleop/setup.py" \
     \
    build --build-base "/home/blackwind/workspace/Nexus-Bots/nexus-ros/jetnano/build/robot_teleop" \
    install \
    --root="${DESTDIR-/}" \
