...
const double initialTheta = 0.000000001;
...
void update_odom()
{
    ...
    // Average anle during the last cycle
    ...
    // Prevent lockup form a single bad cycle
    ...
    // Make sure theta stays i the correct range
...
int main(int argc, char **argv)
{
    ...
    // Publisher of simple odom message where orietation.z is an euler angle
